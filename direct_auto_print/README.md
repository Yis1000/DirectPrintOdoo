...
## Descripción
Módulo para Odoo 18.0 y 19.0 que permite la impresión directa de documentos a una impresora local o de red sin necesidad de descargar previamente el archivo PDF correspondiente.
